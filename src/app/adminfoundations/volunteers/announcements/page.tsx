  ...
  return (
    <div className={`min-h-screen bg-slate-50 dark:bg-[#0B1220] ${display.variable}`} style={{ fontFamily: "var(--font-display)" }}>
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white sm:text-3xl">Notice Board</h1>
          <p className="text-xs sm:text-sm text-slate-500 mt-1">Broadcast urgent needs or general information to all volunteers.</p>
        </div>
