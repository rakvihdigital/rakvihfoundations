  ...
  return (
    <div className={`min-h-screen bg-black ${display.variable}`} style={{ fontFamily: "var(--font-display)" }}>
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-2xl font-extrabold text-white sm:text-3xl">Log Volunteer Hours</h1>
          <p className="text-xs sm:text-sm text-slate-400 mt-1">Record impact hours manually for verified volunteers.</p>
        </div>
