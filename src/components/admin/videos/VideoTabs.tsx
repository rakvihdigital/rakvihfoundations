      ...
      <div className="flex items-center gap-4">
        ...
        <div className="relative pb-2">
          <button
            ...
            className={`rounded-full px-6 py-2 text-xs font-semibold transition-all duration-300 ${
              activeModule === null
          ...
          {activeModule === null && (
            <span className="absolute bottom-0 left-1/2 h-[2px] w-10 -translate-x-1/2 rounded-full bg-[#FFC107]" />
          )}
        </div>
        ...
        {modules.map((module, index) => (
          <div key={module.id} className="relative pb-2">
            ...
            {activeModule === module.id && (
              <span className="absolute bottom-0 left-1/2 h-[2px] w-14 -translate-x-1/2 rounded-full bg-[#FFC107]" />
            )}
          </div>
        ))}
      </div>
