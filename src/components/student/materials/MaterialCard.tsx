...
export default function MaterialCard({ material, onView }: Props) {
  ...
  return (
    ...
    >
      <div className="relative h-44 w-full overflow-hidden">
        <Image
          src={material.thumbnail || "/images/materials-placeholder.png"}
          alt={material.title}
          fill
          unoptimized
          onError={(e) => {
            e.currentTarget.src = "/images/materials-placeholder.png";
          }}
